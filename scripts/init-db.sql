...
CREATE POLICY "enable_insert_transactions" ON transactions FOR INSERT USING (true);
CREATE POLICY "enable_update_transactions" ON transactions FOR UPDATE USING (true);

CREATE POLICY "enable_read_members" ON members FOR SELECT USING (true);
CREATE POLICY "enable_insert_members" ON members FOR INSERT USING (true);
CREATE POLICY "enable_update_members" ON members FOR UPDATE USING (true);

CREATE POLICY "enable_read_cases" ON cases FOR SELECT USING (true);
CREATE POLICY "enable_insert_cases" ON cases FOR INSERT USING (true);
CREATE POLICY "enable_update_cases" ON cases FOR UPDATE USING (true);

CREATE POLICY "enable_read_validation_logs" ON validation_logs FOR SELECT USING (true);
CREATE POLICY "enable_insert_validation_logs" ON validation_logs FOR INSERT USING (true);

CREATE POLICY "enable_read_callback_logs" ON callback_logs FOR SELECT USING (true);
CREATE POLICY "enable_insert_callback_logs" ON callback_logs FOR INSERT USING (true);
