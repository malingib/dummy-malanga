...
export const api = {
  ...
  mpesaConnectionAction: (id: string, action: 'verify' | 'register_callbacks' | 'activate' | 'deactivate') => request<{ success: boolean; data: MpesaConnection | null }>('/api/mpesa/connections', { method: 'PATCH', body: JSON.stringify({ id, action }) }),
